...
#define FFMPEG_CONFIGURATION "--prefix=/root/ffmpeg_build_gpu --pkg-config-flags=--static --extra-cflags='-I/root/ffmpeg_build/include -I/usr/local/cuda/include' --extra-ldflags='-L/root/ffmpeg_build/lib -L/root/ffmpeg_build/lib64 -L/usr/local/cuda/lib64' --extra-libs='-lpthread -lm' --ld=g++ --bindir=/root/bin --enable-cross-compile --enable-gpl --enable-pic --disable-static --enable-shared --enable-libfdk-aac --enable-libvpx --enable-libx264 --enable-libx265 --enable-librsvg --enable-libwebp --enable-libaom --enable-cuda --enable-cuvid --enable-nvenc --enable-libnpp --enable-nonfree --enable-openssl --disable-libxcb --disable-libxcb-shm --disable-libxcb-xfixes --disable-libxcb-shape --disable-xlib --disable-doc --disable-sdl2 --disable-sndio --disable-devices --disable-v4l2-m2m"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/root/ffmpeg_build_gpu/share/ffmpeg"
#define AVCONV_DATADIR "/root/ffmpeg_build_gpu/share/ffmpeg"
